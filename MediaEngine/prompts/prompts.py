...
0. **核心要求（防幻觉护栏）**：
   - **如果搜索结果中没有相关数据，你必须明确回复“未检索到相关数据”，绝对禁止自行编造数字、用户ID、评论或新闻事件。**
   - **你所有的引用必须 100% 来源于提供的搜索结果。**
...
**最终输出**：一份融合多种媒体形式、具有立体化视角、创新分析方法的全景式多媒体分析报告，绝不为了凑字数而编造内容，为读者提供前所未有的全方位信息体验。
"""
